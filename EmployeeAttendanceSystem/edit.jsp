...
<b><font color="#5d8122" face="verdana">Update Details</font></b>
	...
	<s:form action="updates"> 	
			...
			<s:textfield label="Emp Name" value="%{#application.b}" name="mb.emp_name" cssClass="bord"/>
			<s:fielderror><s:param value="%{'attendance'}" /></s:fielderror>
			<s:textfield label="Attendance " value="%{#application.c}" name="mb.attendance" cssClass="bord"/>
